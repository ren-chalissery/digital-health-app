...
info ""
info "The instance stops itself at 22:00 and starts at 08:00 Sydney (~\$13/month). Pass"
info "  NightPauseEnabled=false to the box stack for twenty-four-hour operation."
info ""
info "Stop paying between demonstrations, keeping the address, the disk and the data (~\$6/month):"
