...
open class SimplicityApiAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = SimplicityApiAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: SimplicityApiAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: SimplicityApiAPIConfiguration = SimplicityApiAPIConfiguration.shared
    ) {
        self.method = method
