...
import io.simplicity.training.api.auth.HttpBearerAuth
...
import io.simplicity.training.api.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "io.simplicity.training.api.baseUrl"
        @Deprecated(
